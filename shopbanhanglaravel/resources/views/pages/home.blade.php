...
<div class="features_items"><!--features_items-->
                                    ...
                                    <h3 style="color: #e88b1b" class="heading"> Sản phẩm mới nhất </h3>
               ...
               <!-- hetcot9 -->
                      ...
                      <ul style="transform: translateX(652px);" class="pagination pagination-sm m-t-none m-b-none">
                       {!!$all_product->links()!!}
                      </ul>
        <!--/recommended_items-->
        <!-- @ include('elements.thuonghieu') -->
        @include('elements.carou')
